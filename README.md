...
```bash
pip install https://github.com/StormShynn/sap-abap-agent/releases/download/mcp-server-v1.6.0/sap_abap_agent_mcp-1.6.0-py3-none-any.whl
```
...
```bash
pip install "sap_abap_agent_mcp-1.6.0-py3-none-any.whl[win-dpapi]"
```
...
```bash
pip install "sap_abap_agent_mcp-1.6.0-py3-none-any.whl[playwright]"
