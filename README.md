...
```bash
pip install https://github.com/StormShynn/sap-abap-agent/releases/download/mcp-server-v1.7.10/sap_abap_agent_mcp-1.7.10-py3-none-any.whl
```
...
```bash
pip install "sap_abap_agent_mcp-1.7.10-py3-none-any.whl[win-dpapi]"
```
...
```bash
pip install "sap_abap_agent_mcp-1.7.10-py3-none-any.whl[playwright]"
