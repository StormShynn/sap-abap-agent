...
skills: [sap-daily-learner, sap-extensibility, sap-clean-code]
---
...
- Dùng file `.sap-abap-agent/memory/semantic/LEARNING_PROGRESS.md` để track:
...
Duy trì file `.sap-abap-agent/memory/semantic/LEARNING_PROGRESS.md` với cấu trúc:
