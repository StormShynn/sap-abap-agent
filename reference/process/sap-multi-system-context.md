...
**Dung o dau**: goi tu skill `sap-ask-consultant` (Buoc 5.5, giua Buoc 5 va Buoc 6 cua quy
trinh dispatch) va tu dong "Backend capability" trong system prompt cua 25
`agents/sap-*-consultant-cloud.md` — tat ca tro ve day bang ten khi can biet backend nao
(sap-connect/sap-vsp/sap-dict-bridge) dung cho profile/edition hien tai. Chuyen tu
`skills/sap-multi-system-context/` sang day 2026-07-31 (xem
...
Tai lieu nay giai quyet bang cach:
...
Cache **het han sau 7 ngay** - khi qua han, doc lai tu Buoc 1-3.
...
- 🔗 Buoc tiep theo: goi tool cu the tren backend da chon. Skill `sap-ask-consultant` se
  doc file nay o Buoc 5.5 cua routing matrix (tich hop Phase 4).
